"""
main.py — WhaleX Prime Core v3 (HFT + Telegram Edition)
"""
import asyncio
import logging
...
async def lifespan(app: FastAPI):
    ...
    # 4. Telegram bot setup + queue consumer
    await TG.setup()
...
app = FastAPI(
    ...
    description = "Adaptive HFT — Radar · Co-Pilot · Demo · Admin · Telegram",
    version     = "3.0.0",
    lifespan    = lifespan,
)
...
async def health():
    ...
    return {
        ...
        "telegram_channel":bool(settings.telegram_channel_id),
    }
